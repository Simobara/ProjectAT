                    ...
                    <div>
                        ...
                        >
                            <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                                ...
                                <li className="text-gray-600 hover:text-blue-600">
                                    <NavLink to="/contactUs" activeclassname="active" className="nav-links" onClick={click ? handleClick : null}> ContactUs</NavLink>
                                </li>
                            </ul>
                        </div>
                    </div>
...
export default NavbarCompThree